...
- "body" — 6-10 blocks (heading|text|list). Voice: prediction-market trader's gossip-column take; casual, witty, never preachy. NO "why it probably loses" sections. NO AI filler ("in conclusion", "it's important to note"). NO em dashes anywhere (commas, full stops or brackets). NO binary-contrast shapes: "it's not X, it's Y", a trailing ", not Y", "not just X but Y", "less X, more Y". NO self-answered questions ("How many? One."), no reveal colons ("The best part: it learns."), no mic-drop kickers ("That's it." / "Every time."), no "Here's the thing" or "What most people miss". A joke goes AFTER the claim, so a reader who skips it still gets the point. NO "guaranteed"/"lock"/"risk-free"/"free money"/"can't lose". Headings in sentence case as plain statements/questions (editorial standards 2026-09-12: H1 in Title Case, H2/H3 sentence case, never all-lowercase; keep the dry, direct voice in the heading itself). Use the brief's synonym variants.
